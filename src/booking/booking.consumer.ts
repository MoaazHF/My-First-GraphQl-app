...
export class BookingProcessor extends WorkerHost {
  ...
  async process(job: Job<BookingConfirmationEmailJob>): Promise<void> {
    const {
      bookingId,
      recipientEmail,
      startDate,
      ...
      <div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; max-width: 650px; margin: auto; border: 1px solid #e0e0e0; border-radius: 8px; overflow: hidden; background-color: #ffffff; color: #333333;">
        ...
        <div style="padding: 30px;">
          ...
          <table style="width: 100%; border-collapse: collapse; margin-top: 15px; font-size: 14px;">
            ...
            <tr>
              <td style="padding: 12px 0; border-bottom: 1px solid #eeeeee; font-weight: bold; color: #333;">Total Price</td>
              <td style="padding: 12px 0; border-bottom: 1px solid #eeeeee; color: #555;">$${totalPrice}</td>
            </tr>
          </table>
